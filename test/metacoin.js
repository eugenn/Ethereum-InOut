contract('MetaCoin', function(accounts) {
  ...
  it("should set token name", function(done) {
    var meta = MetaCoin.deployed("Test");

    meta.tokenName.call().then(function(name) {
      assert.equal(name.valueOf(), "Test", "Test is token name");
    }).then(done).catch(done);
  });
